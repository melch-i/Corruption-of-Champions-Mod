...
public function lumiEnhance(justCheck:Boolean = false):Boolean {
	...
	var pig:Function = null;
	if (player.hasItem(consumables.PIGTRUF))
		pig = lumiEnhancePigtailTruffle;
	if(justCheck) {
		return fox != null || kanga != null || seed != null || laBova != null || succuDelight != null || oviElix != null || lustDraft != null || kitsune != null || pig != null;
	}
	outputText("", true);
	...
	if(player.gems < 100) {
		...
		choices(consumables.FOXBERY.shortName, fox,
				...
				consumables.PIGTRUF.shortName, pig,
				"Back", lumiLabChoices);
		return true;
	}
}
