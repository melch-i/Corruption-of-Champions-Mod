...
/**
	...
	public class HermCentaur extends Monster
	{
		...
		private function feminineMusk():void
		{
			...
			if (player.lust <= .5*player.maxLust()) outputText(" your [skin] grows feverishly hot.");
			else 
			{
