...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog20():void {
			...
			outputText("-Metamorph perk would grant increase max ki by 50 and grant access to Metamorph option even if PC not yet have perk Job: Soul Cultivator.\n");
			...
			outputText("+150 to max HP, +50 to max lust, +100 to max Fatigue, +10% to max ki, allow to take one more prestige job.\n");
			outputText("\n");
			outputText("\n");
			...
			outputText("-Add more ki options.\n");
			outputText("-Implement follower Kindra stuff and rest of Archery expansion.\n");
			outputText("-Add ki stuff to our lovely monk-ish mouse ^^\n");
			outputText("-Add ki stuff to kitsune encounters.\n");
			outputText("-Add Wuxia themed area and enemies.\n");
			outputText("-Add few new options during chara creation.\n");
			outputText("-Add option to upgrade some of the items ingame (ofc using ki) and generaly few new shiny things to find/buy/store/use.\n");
			outputText("-More camp build options (involving using stones and etc.)\n");
			outputText("-Few more perks and achievements.\n");
			outputText("-Make use of Metamorph perk (ofc all TF would be powered by ki ^^)\n");
		...
		private function Changelog18():void {
			...
			outputText("-New perk for monsters: True Demon-type enemy. It would amke them not have any ki (since true demons not have soul to gather ki so why they need to have it, right? xD).\n");
		...
		private function Changelog17():void {
			...
			outputText("-Seeing current enemy mana will req. now having Job: Sorcerer perk (non-mage PC's can't feel how much mana enemy body hold ^^) and for enemy ki is required Soul Sense perk (same reason as with enemy mana).\n");
		...
		private function Changelog16():void {
			...
			outputText("-New tier 3 toughness lvl-up perk: Defence Stance. Req. Job: Defender perk and 80+ tou. Effect: Defend move giving 60% phys dmg reduction and allow recovery of fatigue, mana, ki\n");
			outputText("-New tier 4 toughness lvl-up perk: Mastered Defence Stance. Req. Defence Stance perk and 120+ tou. Effect: Defend move giving 75% phys dmg reduction and allow increased (bonus to normal recovery in Defence Stance) recovery of fatigue (+1), mana (+5), ki (+1)\n");
			...
			outputText("-New tier 7 ki lvl-up perk: Flesh Body: Elder Stage. Req. Flesh Body: Warrior Stage perk. Effects: +4 armor, +8 unarmed, +100 max HP (all scalable and gained each time PC gets one of these perks: Soul Exalt, Soul Overlord, Soul Tyrant)\n");
			outputText("-New tier 7 ki lvl-up perk: Daoist: Elder Stage. Req. Daoist: Warrior Stage perk. Effects: +10 to recovered ki during meditation, +40% to soulskill power, +50 max ki (all gained each time PC gets one of these perks: Soul Exalt, Soul Overlord, Soul Tyrant)\n");
		...
		private function Changelog15():void {
			...
			outputText("-New rare ascension perk -> Ascension: Unlocked Potential (2nd Stage). Req. Ascension: Unlocked Potential and be at second ascension. It costs 5 asc points and will give +2 to max lust/wrath and +6 to max ki at each lvl-up.\n");
		...
		private function Changelog14():void {
			...
			outputText("-New tier 5 wisdom lvl-up perk: Unlock Mind (2nd stage). Req. Unlock: Mind perk and 150+ wis. Effect: +5 ki per lvl-up (grant bonus points to respective stat bar retroactively)\n");
			...
			outputText("-Stat caps due to racial modificators can't go below 25. Insightful Resources perks adds only 3 instead of 5 to max ki for each point of wisdom\n");
		...
		private function Changelog13():void {
			...
			outputText("-New option to use ki in Soulforce menu in camp: Adj. Corruption (now PC can rise or lower corruption - Req. Soul Apprentice perk to be unlocked).\n");
			...
			outputText("-Prices for soul recovery pills slight changed with slight increase to amount of recovered ki after use.\n");
			...
			outputText("-New tier 0 ki lvl-up perk: Daoist Cultivator. Req. Job: Soul Cultivator perk. Effects: +10 to recovered ki during meditation, +10% to soulskill power, +25 max ki, -10% to soulskils costs\n");
			outputText("-New tier 1 ki lvl-up perk (multi-rank): Insightful Resources I-V. Req. for rank 1: lvl 6+, 50+ wis, perk Job: Soul Cultivator, Effect. Increase max ki per each point of wisdom.\n");
			outputText("-New tier 1 ki lvl-up perk: Daoist: Apprentice Stage. Req. Daoist Cultivator perk. Effects: +10 to recovered ki during meditation, +20% to soulskill power, +30 max ki (all gained each time PC gets one of these perks: Soul Apprentice, Soul Personage, Soul Warrior)\n");
			...
			outputText("-New tier 4 ki lvl-up perk: Daoist: Warrior Stage. Req. Daoist: Apprentice Stage perk. Effects: +10 to recovered ki during meditation, +30% to soulskill power, +40 max ki (all gained each time PC gets one of these perks: Soul Sprite, Soul Exalt, Soul Overlord)\n");
			...
			outputText("-Perk Kitsune Thyroid Gland changed to reduce Terror/Illusion specials by 3 turns, increase fatigue regeneration in combat by 1 and giving +5 to max speed cap scalable). Terror/Illusion specials have also ki cost added now (half of what cost to use foxfire).\n");
		...
		private function Changelog12():void {
			...
			outputText("-New 6 hour long cultivation option. Also cultivation options now show estimated amount of recovered ki. Also when in shops in He'Xin'Dao that use Spirit Stones the current amount owned by the player will be seen under the text in main window.\n");
			...
			outputText("-New tier 0 ki lvl-up perk: Body Cultivator. Req. Job: Soul Cultivator perk. Effects: +1 armor, +2 unarmed, +25 max HP (all 3 bonuses scalable with NG+ tiers), +0.5% HP regeneration in combat (+1% outside combat)\n");
			outputText("-New tier 1 ki lvl-up perk: Flesh Body: Apprentice Stage. Req. Body Cultivator perk. Effects: +2 armor, +4 unarmed, +50 max HP (all scalable and gained each time PC gets one of these perks: Soul Apprentice, Soul Personage, Soul Warrior)\n");
			outputText("-New tier 4 ki lvl-up perk: Flesh Body: Warrior Stage. Req. Flesh Body: Apprentice Stage perk. Effects: +3 armor, +6 unarmed, +75 max HP (all scalable and gained each time PC gets one of these perks: Soul Sprite, Soul Exalt)\n");
			...
			outputText("-Foxfire specials use now not only fatigue but also ki to cast them. So msg about been too tired may mean having too low ki or too little spare fatigue to cast.\n");
			...
			outputText("-New tier 1 misc lvl-up perk: Metamorph. Requirement: Genetic Memory perk. Adds new option in ki submenu to allow use all unlocked TF effects at cost of 100-600 ki.\n");
		...
		private function Changelog11():void {
			...
			outputText("-New bonuses for kitsunes: Half Kitsune and Kitsune (from 5 pts in race score and at least 2 fox tails): -40 str, +20 spe, +50 int, +40 lib, +100 max fatigue, +20% to max ki. For Nine Tailed Kitsunes (12+ pts in race score and 9 tails): -40 str, +60 spe, +100 int, +40 lib, +300 max fatigue, +40% max ki.\n");
		...
		private function Changelog10():void {
			...
			outputText("-New tier 4 speed lvl-up perk: Job: Soul Archer. Req. Job: Arcane Archer and Soul Apprentice perks. Effects: +25 to spe (scalable with NG tiers), +100 to max fatigue, +300 to max ki.\n");
			...
			outputText("-Training soul crossbow acesable in same shop as others training soul items. And it bring up cap on bonus ki from 260 to 310. Also changed code so now uing only few of whole set of training items will not lower so hard grinded bonus ki.\n");
		...
		private function Changelog9():void {
			...
			outputText("-When PC got 200+ max Soulforce and perk Soul Apprentice it can gain perk Soul Sense that allow with using some ki find few specific enemies. Amount of spent ki depend on enemy enc lvl.\n");
		...
		private function Changelog8():void {
			...
			outputText("-Soulforce use for repressing lust or selfsustain been slight lowered to match lowered generaly amount of max ki attainable in endgame. Also reaching 3rd stage of cultivation (perk Soul Warrior) will add second use of lowering lust or getting refill of the hunger per day.\n");
			...
			outputText("-New Ascension perk: Soul Purity. It works same way like Hardiness but giving +50 to max ki per rank. Max Rank: 20.\n");
			outputText("-Ascension perks to increase max HP, lust, fatigue and ki got now 20 ranks and respectively increasing by 100, 10, 30 and 50 per rank. Due to increased bonus per rank max rank attainabel at each ascension was liited to 5x curent NG tier so at first ascension max rank would be only 5.\n");
		...
		private function Changelog7():void {
			...
			outputText("-Added new items: Soulmetal Ring (+20 to max Soulforce) costing 100 gems, Training Soul Axe (+1 atk, large class of weapon, allow to use Whirlwind and train ki while cultivating), Training Soul Buckler (block rate 3, allow to train ki while cultivating), Training Soul Armor (+1 armor, allow to train ki while cultivating and counts as heavy armor for other perks effects).\n");
			...
			outputText("-Cultivating while wearing any of those 3 items: Training Soul Axe/Bucker/Armor allow gain +1 for each of them used (s0 with all 3 it will be +3) to max ki up to limit of 260 bonus ki points. Depending how many of those items PC wear max limit to rise can vary (only with all three limit is at 260). Only wearing those items when cultivating is req. for gaining this bonus points to ki.\n");
			outputText("-Added new lvl-up perk: Dantain. For PC that have perk Job: Soul Cultivator or any of Soul ... perks increase max ki by 10%.\n");
			...
			outputText("-Put limit on how many times per day PC can use ki to lower lust or fill hunger. Atm by having perk of Job: Soul Cultivator giving 1 use per day one of those options and limit reset at the same time as others daily limits.\n");
			...
			outputText("-Changes slightly amount of hunger recovered when spending ki (instead of 1:1 it's 5:1).\n");
			outputText("-New option to use ki: lowering lust outside combat and aside basic option each one spending more ki unlocks along with progression of PC at cultivation levels (2:1).\n");
			outputText("-New 4th stage of soul cultivation: Soul Sprite (req. lvl 24+ and Soul Warrior perk).\n");
			outputText("-Soul Sprite perk unlocks 5th highest option in exchange option of ki for hungry refilling or lowering lust.\n");
			outputText("-New 8 hours long option for cultivating ki (restoring 15x of amount restored after 1 hour long cultivation - without any other max ki rasing bonuses it would be recovring more ki than it max value).\n");
			...
			outputText("-Changes to perk Job: Munchkin (bonuses to stats lowered from +30 to 4 main stats and +20 to lib down to +25 for main stats and +15 for lib, +5% to max ki).\n");
		...
		private function Changelog6():void {
			...
			outputText("-When unicorn score is 5 or higher PC is considered unicorn and getting following bonuses to stats (scaling with NG tier ofc): +5 spe, +10 int, +50 max hp, +20 max fatigue, +50 max ki\n");
			outputText("-When alicorn score is 6 or higher PC is considered alicorn and getting following bonuses to stats (scaling with NG tier ofc): +5 spe, +20 int, +30 max hp, +50 max fatigue, +150 max ki\n");
			...
			outputText("-Kitsune got now new penatly to stats: -10 tou at 9 tails (same value of penatly with each tail like str) and to make up for this going along lines of them been quite attuned to ki they recived +500 max ki and +200 max fatigue (both scalling with each NG+ tier)\n");
			outputText("-Having alicorn, kitsune or unicorn racial score high enough to have racial bonuses would also increase ki regeneration rate during cultivating. Respectively it's 50%, 500% and 100% of base regeneration rate (for one hour it's 10, 2 hours - 30 and 4 hours - 70).\n");
		...
		private function Changelog4():void {
			...
			outputText("-Added new soul skill: Violet Pupil Transformation (req. at least Soul Personage perk and is a HoT spell that would be constantly draining ki until it run out or PC deactivate skill: it always healing 200 HP per turn using 100 ki so i suppose at lvl 12+ it not so bad healing as long PC can pay ki each turn - oh right it should also not count toward regeneration limit of reg perks ^^).\n");
		...
		private function Changelog3():void {
			...
			outputText("-Having perk History: Cultivation now properly unlock ki option when picked to play prologue in Ignam.\n");
			outputText("-Slight increased start amount of max ki and total max amount later on (5 more at start and at lvl 6 20 more to stay in line of max 100 for mortal not yet on road to cultivation but already getting a hold on using ki ^^)\n");
			...
			outputText("-Added low-grade ki recovery pill (for 5 gems it recovers instantly 20 ki). Ofc buyable at golem in He'Xin'Dao.\n");
			outputText("-Added mid-grade ki recovery pill (for 30 gems it recovers instantly 100 ki). Buyable at golem in He'Xin'Dao (req. PC to have perk Soul Pesonage).\n");
			outputText("-Added ki skill: Triple Thrust - at endgame it pack quite a nice punch aka most of times 1 hit KO all singular type enemies ^^ (but for now adding soulcost makes game bugs so it's for free for now).\n");
			outputText("-Added ki aoe skill: Draco Sweep - at endgame it pack quite a nice punch aka most of times 1 hit KO all group type enemies ^^ (but for now adding soulcost makes game bugs so it's for free for now).\n");
			...
			outputText("-Increased much how much ki is gained during cultivating from 10 to 20 times more (the longer PC cultivate in one go the more it will produce so 4x 1 hour is less than 1x 4 hours ^^). Also prettied up a lil bit text show during that adding few things like amount of restored ki or how much PC have it after cultivation.\n");
