...
package classes.Scenes.Areas.Forest 
{
	...
	public class DryadScene extends BaseContent
	{
		...
		public  function loseTodryad(fromBattle:Boolean = true):void {
			clearOutput();
			if (fromBattle) outputText("Too badly " + (player.HP <= 0 ? "injured" : "aroused") + " by the spriggan, you give in  and let her she wants to you.\n\n");
			if (player.hasCock()) {
