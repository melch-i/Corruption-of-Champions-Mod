...
internal function tentacleLossRape():void {
	...
	if(player.lust >= player.maxLust()) {
		var sac:StatusEffectClass = player.statusEffectByType(StatusEffects.TentacleBadEndCounter);
		if(!sac) {
...
private function tentacleRapeContinuation():void {
	...
	if (player.gender == 1) {
		...
		if (player.cockTotal() == 1)
		{
			outputText("A sharp tug tells you that the creature has sealed itself upon your [cock]. You see " + player.totalBreasts() + " smaller tentacles latch onto your erect nipples. You feel milk begin to leak out as the creature makes a perfect seal around your areola. A thick, phallic tentacle probes underneath your trapped [cock] until it finds your vaginal opening. You cry out as the member punches past your opening and bottoms out in your womb. The tentacle swells up until it completely fills your " + vaginaDescript(0) + ".  ");
			player.cuntChange(player.vaginalCapacity() * .76, true, false, true);
			outputText("With freakish coordination, the beast sucks your [cock] and tits while hammering away at your " + vaginaDescript(0) + ". The overwhelming pleasure courses through your body and triggers an immediate orgasm, sending gouts of cum into the tentacle sealed around your [cock]. The sensation of your fluids entering the creature prompts it to suck your [cock] harder as well as hammer your " + vaginaDescript(0) + " faster, leading to a chain of orgasms.\n\n");
