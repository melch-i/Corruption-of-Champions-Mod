	...
	public class BodyLotion extends Consumable 
	{
		...
		override public function useItem():Boolean {
			if (game.player.skinTone == _adj) {
				outputText("You take a second to disrobe before uncorking the flask of lotion and rubbing the " + liquidDesc() + " across your body. Once you’ve finished you feel reinvigorated. ");
				...
				switch(game.player.skinType) {
					case 0: //Plain
						outputText("You take a second to disrobe before uncorking the flask of lotion and rubbing the " + liquidDesc() + " across your body. As you rub the mixture into your arms and [chest], your whole body begins to tingle pleasantly. ");
						switch(_adj) {
							case "smooth":
						...
						break;
					case 1: //Fur
						outputText("Once you’ve disrobed you take the lotion and begin massaging it into your skin despite yourself being covered with fur. It takes little effort but once you’ve finished... nothing happens. A few moments pass and then your skin begins to tingle. ");
						switch(_adj) {
							case "smooth":
					...
					case 3: //Goo
						...
						break;
					default:
						outputText("You take a second to disrobe before uncorking the bottle of oil and rubbing the smooth liquid across your body. Even before you’ve covered your arms and [chest] your skin begins to tingle pleasantly all over. After your skin darkens a little, it begins to change until you have " + _adj + " skin.");
				}
			}
